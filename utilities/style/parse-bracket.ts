import { parse, MAX_MULTIPLIER_DEPTH } from './parse';
 ...
 */
function hasBracketsMultiplier(input: string): boolean {
 ...
 */
function parseBracketsMultiplier(input: string): string[] {
...
export { hasBrackets, hasBracketsMultiplier, parseBrackets, parseBracketsMultiplier };
