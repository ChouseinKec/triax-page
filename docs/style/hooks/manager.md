...
- **Parameters:**
  - `property: StyleKeys` — The style property to get.
...
- **Parameters:**
  - `property: StyleKeys` — The style property to set.
...
- **Parameters:**
  - `property: StyleKeys` — The style property to copy.
...
- **Parameters:**
  - `property: StyleKeys` — The style property to paste into.
...
- **Parameters:**
  - `property: StyleKeys` — The style property to reset.
