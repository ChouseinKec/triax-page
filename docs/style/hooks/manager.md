...
- **Parameters:**
  - `property: StyleKey` — The style property to set.
...
- **Parameters:**
  - `property: StyleKey` — The style property to copy.
...
- **Parameters:**
  - `property: StyleKey` — The style property to paste into.
...
- **Parameters:**
  - `property: StyleKey` — The style property to reset.
