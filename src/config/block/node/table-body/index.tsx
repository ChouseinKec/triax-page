...
// Components
import BlockTableBodyComponent from '@/config/block/node/table-body/component';

registerNode({
    key: 'core-table-body',
    name: "Table Body",
    description: "A table body section that can hold data rows.",
    category: 'table',
    icon: (
    ...
    component: BlockTableBodyComponent,
});