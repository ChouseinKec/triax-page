...
// Components
import BlockHgroupComponent from '@/config/block/node/hgroup/component';

registerNode({
	key: 'core-hgroup',
	name: "Heading Group",
	description: "A heading group that contains a main heading with related content like subheadings or taglines.",
	category: 'text',
	icon: (
	...
	component: BlockHgroupComponent,
});