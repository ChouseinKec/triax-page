...
// Components
import BlockTableColgroupComponent from '@/config/block/node/table-colgroup/component';

registerNode({
    key: 'core-table-colgroup',
    name: "Table Colgroup",
    ...
    elementKeys: ['colgroup'],

    defaultStyles: {},
    defaultAttributes: {},
    defaultData: {},

    component: BlockTableColgroupComponent,
});