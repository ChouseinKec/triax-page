...
// Components
import BlockTableFootComponent from '@/config/block/node/table-foot/component';

registerNode({
    key: 'core-table-foot',
    name: "Table Foot",
    description: "A table foot section that can hold footer rows.",
    category: 'table',
    icon: (
    ...
    component: BlockTableFootComponent,
});