...
// Components
import BlockListItemComponent from '@/config/block/node/list-item/component';

registerNode({
    key: 'core-list-item',
    name: "List Item",
    description: "A list item block for use within lists.",
    category: 'list',
    icon: (
    ...
    component: BlockListItemComponent,
});