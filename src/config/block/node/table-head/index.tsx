...
// Components
import BlockTableHeadComponent from '@/config/block/node/table-head/component';

registerNode({
    key: 'core-table-head',
    name: "Table Head",
    description: "A table head section that can hold header rows.",
    category: 'table',
    icon: (
    ...
    component: BlockTableHeadComponent,
});