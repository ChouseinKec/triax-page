...
/**
 * Renders a header block that contains child elements.
 *
 * @param nodeID - The unique identifier of the block instance
 * @param children - Child blocks to render inside this header
 * @returns JSX element representing the header block
 */
const BlockHeaderComponent: React.FC<NodeComponentProps> = ({ deviceKey, orientationKey, pseudoKey, isSelected, nodeID, children }) => {
    ...
    return showPlaceholder ? (
        <Placeholder
            title="Empty Header"
            description="Add content to this header"
            actions={[
                {
                    label: "Add Content",
...
export default memo(BlockHeaderComponent);