...
// Components
import BlockTableHeaderCellComponent from '@/config/block/node/table-header-cell/component';

registerNode({
    key: 'core-table-header-cell',
    name: "Table Header Cell",
    description: "A table header cell block for labeling columns or rows.",
    category: 'table',
    icon: (
    ...
    component: BlockTableHeaderCellComponent,
});