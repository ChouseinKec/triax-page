...
// Components
import BlockTableCaptionComponent from '@/config/block/node/table-caption/component';

registerNode({
    key: 'core-table-caption',
    name: "Table Caption",
    description: "A table caption that describes the table content.",
    category: 'table',
    icon: (
    ...
    component: BlockTableCaptionComponent,
});