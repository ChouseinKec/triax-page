...
import { DOCUMENT_DEFINITIONS } from './document';

// Register elements directly
registerElements([...FLOW_DEFINITIONS, ...SECTIONING_DEFINITIONS, ...HEADING_DEFINITIONS, ...PHRASING_DEFINITIONS, ...EMBEDDED_DEFINITIONS, ...INTERACTIVE_DEFINITIONS, ...PALPABLE_DEFINITIONS, ...LIST_DEFINITIONS, ...TABLE_DEFINITIONS, ...FORM_DEFINITIONS, ...DOCUMENT_DEFINITIONS]);
