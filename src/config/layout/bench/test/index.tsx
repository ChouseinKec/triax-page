import { registerBench } from '@/core/layout/bench/state/registry';

// Components
import BenchTestComponent from '@/config/layout/bench/test/component';
