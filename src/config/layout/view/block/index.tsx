...
// Components
import ViewBlockComponent from '@/config/layout/view/block/component';
import DeviceSelect from "./device-select";

// Registry
import { registerView, registerActions } from '@/core/layout/view/state/registry';
...
// Register directly
registerView(ViewDefinitionBlock);
