...
/**
 * Block Inspector panel definition.
 * A panel that provides detailed inspection and editing capabilities for selected blocks.
 */
const MainInspector: PanelDefinition = {
	id: "main-inspector",
	title: "Inspector",
	initialPosition: { top: "3.5%", left: "88%" },
	initialSize: { width: "300px", height: "96%", minWidth: 300, minHeight: 250 },
	icon: (
