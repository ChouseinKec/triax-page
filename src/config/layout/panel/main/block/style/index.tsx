...
// Components
import BlockStyleTabComponent from "@/src/config/layout/panel/main/block/style/component";

export const BlockStyleTab: PanelTabDefinition = {
    id: "block-style",
    panelID: "main-inspector",
    title: "Block Styles",
    component: BlockStyleTabComponent,
    icon: (
