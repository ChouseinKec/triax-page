...
// Components
import StylesLayout from "@/src/page/component/block/style/layout/component";

// Managers
import { useSelectedBlockID, canBlockHaveStyles } from "@/src/page/service/managers/block";
...
const BlockStyles: React.FC = () => {
    ...
    const renderContent = () => {
        ...
        return <StylesLayout blockID={selectedBlockID} />;
    };
