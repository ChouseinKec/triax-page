...
// Constants
import { DEFAULT_PSEUDO_ID } from "@/src/page/core/page/constants/defaults";

// Managers
import { getAllPseudos, useSelectedPseudoID } from "@/src/page/service/managers/page";
import { setSelectedPseudoID } from "@/src/page/service/managers/page/commands";
 ...
 *
 * @returns The rendered pseudo selector component
 */
const PseudoSelect: React.FC = () => {
    const allPseudos = getAllPseudos().filter(pseudo => !pseudo.hidden);
    const selectedPseudoID = useSelectedPseudoID() || DEFAULT_PSEUDO_ID;
    ...
    return (
        <DropdownSelect
            ...
            onChange={(value) => setSelectedPseudoID(value)}
        />
    );
};
