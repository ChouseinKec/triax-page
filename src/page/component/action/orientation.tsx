...
// Constants
import { DEFAULT_ORIENTATION_ID } from "@/src/page/core/page/constants/defaults";

// Managers
import { getAllOrientations, useSelectedOrientationID } from "@/src/page/service/managers/page";
import { setSelectedOrientationID } from "@/src/page/service/managers/page/commands";
...
const OrientationSelect: React.FC = () => {
    const allOrientations = getAllOrientations().filter(orientation => !orientation.hidden);
