...
// Constants
import { DEFAULT_DEVICE_ID } from "@/src/page/core/page/constants/defaults";

// Managers
import { getAllDevices, useSelectedDeviceID } from "@/src/page/service/managers/page";
import { setSelectedDeviceID } from "@/src/page/service/managers/page/commands";
...
const DeviceSelect: React.FC = () => {
    const allDevices = getAllDevices().filter(device => !device.hidden);
    const selectedDeviceID = useSelectedDeviceID() || DEFAULT_DEVICE_ID;
