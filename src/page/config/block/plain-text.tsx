...
// Components
import PlainTextRender from "@/src/page/component/block/plain-text";

// Types
import { BlockDefinition } from '@/src/page/core/block/block/types';
...
const PlainTextBlock: BlockDefinition = {
    ...
    render: (instance) => <PlainTextRender instance={instance} />,
};
