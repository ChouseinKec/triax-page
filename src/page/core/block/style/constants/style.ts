// Types
import type { StyleDefinition, StyleKey } from '@/src/page/core/block/style/types';
...
import { getTokenCanonical, expandTokens, parseSyntax, extractSeparators } from '@/src/page/core/block/style/utilities';
