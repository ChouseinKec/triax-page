import type { DeviceDefinition, DeviceInstance, DeviceID, DeviceRecord } from '@/src/page/core/page/types/device';
import type { OrientationDefinition, OrientationInstance, OrientationID, OrientationRecord } from '@/src/page/core/page/types/orientation';
import type { PseudoDefinition, PseudoInstance, PseudoID, PseudoRecord } from '@/src/page/core/page/types/pseudo';
import type { BarActionInstance, BarActionID, BarActionRecord } from '@/src/page/core/page/types/action';
import type { ValidateResult } from '@/src/shared/types/result';

// Helpers
import { validateDeviceDefinition, validateOrientationDefinition, validatePseudoDefinition } from '@/src/page/service/helpers/page';
