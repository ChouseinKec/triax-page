// Types
import type { TabDefinition } from '@/src/page/layout/core/types/tab';
	
// Components
import BlocksHierarchy from '@/src/page/component/block/hierarchy/component';

export const BlockHierarchyTab: TabDefinition = {
	id: 'block-hierarchy',
	panelID: 'block-hierarchy',
	title: 'Block Hierarchy',
	component: BlocksHierarchy,
	icon: (
...
export default BlockHierarchyTab;