// Types
import type { PanelDefinition } from '@/src/page/layout/core/types';

/**
 * Block Hierarchy panel definition.
 * A panel that displays the hierarchical structure of blocks in the editor.
 */
const BlockHierarchy: PanelDefinition = {
    id: "block-hierarchy",
    title: "Block Hierarchy",
    initialPosition: { top: "7%", left: "3.5%" },
    initialSize: { width: "200px", height: "91%", minWidth: 200, minHeight: 250 },
    icon: (
