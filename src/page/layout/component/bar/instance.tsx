...
import type { BarActionInstance } from "@/src/page/layout/core/types/bar";

// Managers
import { useBarActions } from "@/src/page/layout/service/manager";
 ...
 * @returns The rendered Bar or null if no actions
 */
const Bar: React.FC<BarProps> = ({ title = "Bar", position = { top: "0px", left: "0px" }, size = { width: "25%", height: "35px" }, barID, isTransparent }) => {
    ...
    return (
        <div className={CSS.Bar} style={styles} title={title} data-transparent={String(isTransparent)}>
            {actionInstances &&
