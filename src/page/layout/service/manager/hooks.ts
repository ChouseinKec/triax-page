...
// Types
import type { PanelInstance, BarID, BarActionInstance, InfoID, InfoDataInstance } from '@/src/page/layout/core/types';
...
// Helpers
import { validateBarID, validateInfoID } from '@/src/page/layout/service/helper/validate';
