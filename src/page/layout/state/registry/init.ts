...
// Definitions
import { CorePanels } from '@/src/page/layout/config/panels';
import { CoreBars } from '@/src/page/layout/config/bars';
import { CoreTabs } from '@/src/page/layout/config/tabs';
import { CoreInfos } from '@/src/page/layout/config/info';

// Types
import type { PanelDefinition, BarDefinition, TabDefinition, InfoDefinition } from '@/src/page/layout/core/types';
