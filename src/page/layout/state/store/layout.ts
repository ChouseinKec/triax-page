...
// Types
import type { PanelID, PanelInstance, TabInstance, PanelRecord } from '@/src/page/layout/core/types';
import type { BarDefinition, BarID } from '@/src/page/layout/core/types';
import type { BarRecord, BarActionInstance, BarActionID } from '@/src/page/layout/core/types/bar';
import type { InfoDefinition, InfoID, InfoRecord, InfoDataInstance, InfoDataID } from '@/src/page/layout/core/types/info';

// Registry
import { getRegisteredPanels, getRegisteredTabs, getRegisteredBars, getRegisteredInfos } from '@/src/page/layout/state/registry';
