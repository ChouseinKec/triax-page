import { hasDoubleBar, hasDoubleAmp, hasSingleBar, hasComma, hasSequence, parseComma, parseDoubleBar, parseDoubleAmp, parseSingleBar, parseSequence } from '@/core/block/style/instance/utilities/parse/combinator';
