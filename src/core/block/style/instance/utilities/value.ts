// Utilities
import { getTokenCanonical } from '@/core/block/style/instance/utilities';
import { devLog } from '@/shared/utilities/dev';

// Types
import type { TokenTypeKey, RegisteredTokenTypes, StyleValue } from '@/core/block/style/definition/types';
 ...
 */
export function getValueType(styleValue: StyleValue, tokenTypeDefinitions: RegisteredTokenTypes): TokenTypeKey | undefined {
 ...
 */
export function getValueToken(styleValue: StyleValue, tokenTypeDefinitions: RegisteredTokenTypes): string | undefined {
 ...
 */
export function getValueTokens(styleValues: StyleValue[], tokenTypeDefinitions: RegisteredTokenTypes): string[] {
