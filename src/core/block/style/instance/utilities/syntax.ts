// Types
import type { StyleKey, StyleSyntaxRaw, StyleSyntaxParsed, StyleSyntaxSet, StyleSyntaxSeparators, RegisteredTokens, RegisteredTokenTypes } from '@/core/block/style/definition/types/';

// Utilities
import { expandTokens, parseSyntax, getTokenCanonical, extractSeparators } from '@/core/block/style/instance/utilities';
...
export function getSyntaxParsed(styleKey: StyleKey, syntaxRaw: StyleSyntaxRaw, tokenDefinitions: RegisteredTokens, tokenTypeDefinitions: RegisteredTokenTypes): StyleSyntaxParsed {
...
export function getSyntaxNormalized(styleKey: StyleKey, syntaxParsed: StyleSyntaxParsed, tokenTypeDefinitions: RegisteredTokenTypes): StyleSyntaxParsed {
