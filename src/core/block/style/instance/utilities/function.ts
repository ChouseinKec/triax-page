...
import type { RegisteredTokenTypes } from '@/core/block/style/definition/types/';
 ...
 */
export function matchFunctionOption(options: OptionDefinition[], value: string, tokenTypeDefinitions: RegisteredTokenTypes): OptionDefinition | undefined {
