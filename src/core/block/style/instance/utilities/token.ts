// Type
import type { TokenRaw, TokenTypeKey, TokenParam, TokenBase, TokenCanonical, RegisteredTokenTypes, RegisteredTokens } from '@/core/block/style/definition/types';
 ...
 */
export function getTokenCanonical(tokenRaw: TokenRaw, tokenTypeDefinitions: RegisteredTokenTypes): TokenCanonical | undefined {
 ...
 *
 */
export function getTokenBase(tokenRaw: TokenRaw, tokenTypeDefinitions: RegisteredTokenTypes): TokenBase | undefined {
 ...
 *
 */
export function getTokenParam(tokenRaw: TokenRaw, tokenTypeDefinitions: RegisteredTokenTypes): TokenParam | undefined {
 ...
 */
export function getTokenType(tokenRaw: TokenRaw, tokenTypeDefinitions: RegisteredTokenTypes): TokenTypeKey | undefined {
 ...
 */
export function getTokenValue(tokenRaw: TokenRaw, tokenDefinitions: RegisteredTokens, tokenTypeDefinitions: RegisteredTokenTypes): string | undefined {
 ...
 */
export function getTokenValues(tokens: string[], tokenDefinitions: RegisteredTokens, tokenTypeDefinitions: RegisteredTokenTypes): string[] {
 ...
 */
export function expandTokens(syntax: string, tokenDefinitions: RegisteredTokens, tokenTypeDefinitions: RegisteredTokenTypes, seen = new Set<string>()): string {
