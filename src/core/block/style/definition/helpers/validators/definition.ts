// Types
import type { RegisteredTokenTypes, StyleDefinition, StyleKey, StyleDescription, StyleSyntaxRaw, StyleIcon, StyleLonghand, StyleValue, RegisteredTokens } from '@/core/block/style/definition/types/';
import type { ValidateResult } from '@/shared/types/result';

// Utilities
import { splitAdvanced } from '@/shared/utilities/string';
import { getValueTokens } from '@/core/block/style/instance/utilities';
import { getSyntaxNormalized, getSyntaxParsed } from '@/core/block/style/instance/utilities';
 ...
 */
export function validateStyleValue(styleKey: StyleKey, styleDefinition: StyleDefinition, styleValue: unknown, tokenTypeDefinitions: RegisteredTokenTypes, tokenDefinitions: RegisteredTokens): ValidateResult<StyleValue> {
