...
import type { StyleValue, RegisteredStyles, StyleKey, UnitDefinitionRecord } from '@/core/block/style/definition/types';
 ...
 */
export type RegisteredTokens = Record<TokenKey, TokenDefinition>;

/**
 * Record mapping TokenTypeKey to TokenTypeDefinition
 */
export type RegisteredTokenTypes = Record<TokenTypeKey, TokenTypeDefinition>;
