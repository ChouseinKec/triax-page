// Types
import type { StyleKey, StyleSyntaxRaw, StyleSyntaxParsed, StyleSyntaxSet, StyleSyntaxSeparators, RegisteredTokens, RegisteredTokenTypes } from '@/core/block/style/types/';
