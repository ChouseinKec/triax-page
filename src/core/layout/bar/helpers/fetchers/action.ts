...
// Helper
import { fetchBar } from '@/src/core/layout/bar/helpers/fetchers/bar';
 ...
 * @returns PickResult containing the bar actions array or error message
 * @example
 ...
 */
export function fetchBarActions(barID: BarID, allBars: BarRecord): PickResult<BarActionInstance[]> {
