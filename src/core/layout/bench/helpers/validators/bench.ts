// Types
import type { BenchDefinition, BenchKey, BenchIcon, BenchOrder, BenchName, BenchComponent } from '@/core/layout/bench/types';
...
export function validateBenchIcon(benchIcon: unknown): ValidateResult<BenchIcon> {
	...
	return { valid: false, message: `BenchEditor icon must be a string or React element, got: ${typeof benchIcon}` };
}
