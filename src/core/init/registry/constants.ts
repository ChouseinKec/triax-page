// Registry functions
import { registerBlock } from '@/src/core/block/instance/registry';
import { registerPanel, registerPanelTab } from '@/src/core/layout/panel/registry';
import { registerBar } from '@/src/core/layout/bar/registry';
import { registerDevice, registerPseudo, registerOrientation, registerAction } from '@/src/core/layout/page/registry';
import { registerViewport } from '@/src/core/layout/viewport/registry';
import { registerWorkbench } from '@/src/core/layout/workbench/registry';
