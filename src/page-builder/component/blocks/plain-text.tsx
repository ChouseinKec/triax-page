...
// Managers
import { useIsBlockSelected, selectBlock } from '@/src/page-builder/service/managers/block';
import { getBlockContent, setBlockContent } from '@/src/page-builder/service/managers/block';

const PlainTextRender: React.FC<{ instance: BlockInstance }> = ({ instance }) => {
