 ...
 *
 * @param props - LayoutInfoProps
 * @returns The rendered LayoutInfo or null if no data
 */
const LayoutInfo: React.FC<LayoutInfoProps> = ({ title = "LayoutInfo", position = { top: "0px", left: "0px" }, size = { width: "300px", height: "50px" }, infoID, grid = { columns: 1, rows: 1 } }) => {
    ...
    return (
        <div className={CSS.LayoutInfo} style={styles} title={title}>
...
export default memo(LayoutInfo);
