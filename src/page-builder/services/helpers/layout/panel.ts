// Types
import type { PanelDefinition, PanelID, PanelTitle, PanelPosition, PanelSize, PanelOrder, PanelIcon } from '@/src/page-builder/core/editor/layout/types';
import type { ValidationResult } from '@/src/shared/types/result';

// Utilities
import { isPanelDefinitionValid, isPanelLockedValid, isPanelOpenValid, isPanelIDValid, isPanelTitleValid, isPanelPositionValid, isPanelSizeValid, isPanelIconValid, isPanelOrderValid } from '@/src/page-builder/core/editor/layout/utilities';
 ...
 * @returns ValidationResult containing validity and the validated PanelID if valid
 *
 * @example
 * validatePanelID('panel-123') → { valid: true, value: 'panel-123' }
 */
export function validatePanelID(panelID: unknown): ValidationResult<PanelID> {
 ...
 * @returns ValidationResult containing validity and the validated PanelTitle if valid
 *
 * @example
 * validatePanelTitle('My Panel') → { valid: true, value: 'My Panel' }
 */
export function validatePanelTitle(panelTitle: unknown): ValidationResult<PanelTitle> {
 ...
 * @returns ValidationResult containing validity and the validated PanelPosition if valid
 *
 * @example
 * validatePanelPosition({ x: 10, y: 20 }) → { valid: true, value: { x: 10, y: 20 } }
 */
export function validatePanelPosition(panelPosition: unknown): ValidationResult<PanelPosition> {
 ...
 * @returns ValidationResult containing validity and the validated PanelSize if valid
 *
 * @example
 * validatePanelSize({ width: 100, height: 50 }) → { valid: true, value: { width: 100, height: 50 } }
 */
export function validatePanelSize(panelSize: unknown): ValidationResult<PanelSize> {
 ...
 * @returns ValidationResult containing validity and the validated PanelOrder if valid
 *
 * @example
 * validatePanelOrder(1) → { valid: true, value: 1 }
 */
export function validatePanelOrder(panelOrder: unknown): ValidationResult<PanelOrder> {
 ...
 * @returns ValidationResult containing validity and the validated PanelIcon if valid
 *
 * @example
 * validatePanelIcon(<Icon name="star" />) → { valid: true, value: <Icon name="star" /> }
 */
export function validatePanelIcon(panelIcon: unknown): ValidationResult<PanelIcon> {
 ...
 * @returns ValidationResult containing validity and the validated boolean if valid
 *
 * @example
 * validatePanelLocked(true) → { valid: true, value: true }
 */
export function validatePanelLocked(panelLocked: unknown): ValidationResult<boolean> {
 ...
 */
export function validatePanelOpen(panelOpen: unknown): ValidationResult<boolean> {
 ...
 * @returns ValidationResult containing validity and the validated PanelDefinition if valid
 *
 * @example
 ...
 */
export function validatePanelDefinition(panelDefinition: unknown): ValidationResult<PanelDefinition> {
