// Types
import type { StyleDefinition, StyleKeys } from '@/editors/block/types/core/style/style';
...
import { getTokenCanonical, expandTokens } from '@/editors/block/utilities/style/token';
import { parseSyntax } from '@/editors/block/utilities/style/parse';
import { extractSeparators } from '@/editors/block/utilities/style/separator';
 ...
 */
export function createProperty(name: StyleKeys, syntax: string): StyleDefinition {
	...
	return {
		name,
		description: StylePropertyDescription[name as keyof typeof StyleDefinitions] ?? '',
		syntaxRaw: syntax,
		get syntaxExpanded() {
 ...
 */
export const StyleDefinitions: Record<StyleKeys, StyleDefinition> = {
	// ============ Display & Layout =============
 ...
 */
export const StyleShorthandDefinitions: Partial<Record<StyleKeys, StyleKeys[]>> = {
