...
// Types
import type { PanelInstance, PanelTabInstance, PanelRecord, PanelContextType } from "@/editors/layout/types/components/panel";

// Registry
import { getRegisteredPanels } from "./registry/registry";
...
export const LayoutProvider = ({ children }: { children: ReactNode }) => {
    ...
    const togglePanel = useCallback((panelID: string) => {
        ...
        setPanels(prev => {
            const panel: PanelInstance | undefined = prev[panelID];
            if (!panel) {
    ...
    const contextValue = useMemo(() => ({
        ...
        [panels] // Remove callback dependencies since they're now stable
    );
