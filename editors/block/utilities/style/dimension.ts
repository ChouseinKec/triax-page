...
import type { UnitKeys } from '@/editors/block/types/core/style/unit';
import type { ValueDefinition } from '@/editors/block/types/core/style/value';
 ...
 */
export function extractDimensionNumber(input: ValueDefinition): ValueDefinition | undefined {
