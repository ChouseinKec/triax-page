 ...
 *
 * Second level in hierarchy: AttributeEditor -> Layouts.
 */
export interface AttributesEditorLayoutsProps {}

/**
 * Props for a single attributes editor layout
 * (defines structure for one layout instance).
 *
 * Third level in hierarchy: AttributeEditor -> Layouts -> Layout.
 */
export interface AttributesEditorLayoutProps {
	/** Label to display for the editor */
	label: string | ReactElement;
	/** Title of the attribute editor */
	title: string;
	/** Groups of attributes to display */
	groups: AttributesEditorGroupProps[];
}
 ...
 *
 * Fourth level in hierarchy: AttributeEditor -> Layouts -> Layout -> Category.
 */
export interface AttributesEditorCategoryProps {
 ...
 *
 * Fifth level in hierarchy: AttributeEditor -> Layouts -> Layout -> Category -> Group.
 */
export interface AttributesEditorGroupProps {
	/** Whether the group should be hidden */
	hidden?: boolean;
	/** Properties/attributes in this group */
	properties: AttributesEditorPropertyProps[];
 ...
 *
 * Sixth level in hierarchy: AttributeEditor -> Layouts -> Layout -> Category -> Group -> Property.
 */
export interface AttributesEditorPropertyProps {
 ...
 *
 * Seventh level in hierarchy: AttributeEditor -> Layouts -> Layout -> Category -> Group -> Property -> Value.
 */
export interface AttributesEditorValueProps {
