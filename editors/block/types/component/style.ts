...
// Types
import type { StyleKeys, StyleDefinition } from '@/editors/block/types/core/style/style';
 ...
 */
export type StylesEditorCategoryProps = {
 ...
 */
export type StylesEditorGroupProps = {
	/** Whether the group should be hidden */
	hidden?: boolean;
	/** Style properties in this group */
	properties: StylesEditorPropertyProps[];
 ...
 */
export interface StylesEditorPropertyProps {
 ...
 */
export interface StylesEditorValue {
 ...
 */
export type StylesEditorValueColorProps = {
	/** Current color value */
	value: string;
 ...
 */
export type StylesEditorValueDimensionProps = {
 ...
 */
export type StylesEditorValueFunctionProps = {
 ...
 */
export type StylesEditorValueIntegerProps = {
 ...
 */
export type StylesEditorValueKeywordProps = {
 ...
 */
export type StylesEditorValueLinkProps = {
	/** Current URL value */
	value: string;
 ...
 */
export type StylesEditorValueNumberProps = {
 ...
 */
export type StylesEditorSlotProps = {
	/** Current slot value */
	value: string;
 ...
 */
export type StylesEditorSlotsProps = {
	/** Current slot values */
	values: string[];
